...
const Employees = new AllEmployees()
...
class Manager extends Employee {
  ...
  hire(newEmployee) {
  this.reports = `${newEmployee}`
  }
  fire(index) {
   delete this.reports
  }
}
const John = new Employee('John', 'Smith', 'john@gmail.com', 30)
// console.log(John)
const Carlos = new Manager('Carlos', 'Chavez', 'carlos@gmail.com', 31);
 console.log(Carlos)
